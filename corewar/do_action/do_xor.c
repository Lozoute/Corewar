/*
** do_xor.c for  in /home/vieira_q/Prog_elem_C/CPE_2014_corewar/corewar/
** 
** Made by quentin vieira
** Login   <vieira_q@epitech.net>
** 
** Started on  Sun Dec 14 04:08:34 2014 quentin vieira
** Last update Sun Dec 14 17:14:16 2014 Thibaud Auzou
*/
...
int		do_xor(t_board *board, t_champ **champs, t_champ *champ)
{
  t_param	*p;
  int		p1;
  int		p2;
