/*
** do_add.c for  in /home/vieira_q/Prog_elem_C/CPE_2014_corewar/corewar/
** 
** Made by quentin vieira
** Login   <vieira_q@epitech.net>
** 
** Started on  Sun Dec 14 04:06:53 2014 quentin vieira
** Last update Sun Dec 14 17:17:04 2014 Thibaud Auzou
*/
...
int		do_add(t_board *board, t_champ **champs, t_champ *champ)
{
  int		reg1;
  int		reg2;
  int		reg3;
